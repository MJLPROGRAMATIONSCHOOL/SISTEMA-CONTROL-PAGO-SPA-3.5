<%-- 
    Document   : Empresa
    Created on : 6/12/2020, 11:56:42 PM
    Author     : lainc
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    <div>
                        <a data-toggle="modal" href="#mdlEmpresa" class="btn btn-success btn-flat"><i class="fa fa-plus"></i>  Nueva Empresa</a>
                    </div>
                    <br>

                    <!-- Agregar Colaborador Modal -->
                    <div class="modal fade in" id="mdlEmpresa" aria-hidden="false">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    <h4 class="modal-title"> Gestion Empresas</h4>
                                </div>
                                <form class="form" id="frmEmpresa">
                                    <div class="modal-body">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            <span class="input-group-addon"><i class="fa fa-folder"></i></span>
                                                            <input name="txtRazonSocial" id="txtRazonSocial" autofocus="" required="" type="text" class="form-control" placeholder="Santana Brayan">
                                                        </div>                                        
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            <span class="input-group-addon"><i class="fa fa-folder"></i></span>
                                                            <input name="txtDireccion" id="txtDireccion" autofocus="" required="" type="text" class="form-control" placeholder="Santana Mayorga">
                                                        </div>                                        
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">                                               
                                                            <span class="input-group-addon"><i class="fa fa-folder"></i></span>
                                                            <input name="txtGiro" id="txtGiro" autofocus="" required="" type="text" class="form-control" placeholder="Unimarc SA">
                                                        </div>                                        
                                                    </div>
                                                </div>                                                
                                            </div>                                          
                                        ...
                                        <div class="form-check form-group">
                                            <div class="custom-control custom-checkbox my-1 mr-sm-2 estado">
                                                ...
                                                <label class="custom-control-label" for="chkVigencia">Disponibilidad de la Empresa.</label>
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="modal-footer">
                    ...
                    <div class="box">    
                        <div class="container-fluid" style="margin-top: 5px">
                            <div class="box-header with-border">             
                                <h3 class="box-title">Listado de las Empresas</h3>
                            </div>
                            <div class="box-body">
                                <div class="table-responsive" >                                 
                                    <table class="table table-bordered table-striped dataTable table-hover" id="TablaEmpresa" class="display">
                                        <thead>
                                            <tr>
                                                <th>Rut</th>
                                                <th>Razon Social</th>

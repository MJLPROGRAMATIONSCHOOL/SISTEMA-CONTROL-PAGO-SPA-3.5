<%-- 
    ...
    Created on : 31/12/2020, 12:38:05 AM
    Author     : lainc
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <div class="modal fade in" id="mdlPagos" aria-hidden="false">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">                                               
                                                        ...
                                                        <input name="descripcion" id="descripcion" autofocus="" required="" type="text" class="form-control" placeholder="Profesor">
                                                    </div>
                                                </div>
                                            </div>                                         
                                        </div>                                       
                        ...
                        <div class="container-fluid" style="margin-top: 5px">
                            <div class="box-header with-border">             
                                ...
                                <div class="pull-right box-tools">
                                    <h4 class="box-title" style="font-size: 1.1rem;"></h4>
                                </div>
                            </div>
                            <div class="box-body">
                                <div class="table-responsive" >                                 
                                    <table class="small table table-bordered table-striped dataTable table-hover" id="tablaPagos" class="display">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Fechas</th>
                            ...
                            <div class="box-footer">
                                <div style="text-align: end;">
                                    <a href="Movimiento.jsp" class="btn bg-success" type="button">Regresar</a>
                                </div>
                            </div>
                        </div>
                    </div>

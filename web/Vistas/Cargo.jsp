<%-- 
    Document   : Cargo
    Created on : 1/12/2020, 09:59:13 PM
    Author     : lainc
--%>
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    <div>
                        <a data-toggle="modal" href="#mdlCargo" class="btn btn-success btn-flat"><i class="fa fa-plus"></i>  Nuevo Cargo</a>
                    </div>
                    <br>

                    <!-- Agregar Cargo Modal -->
                    <div class="modal fade in" id="mdlCargo" aria-hidden="false">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    <h4 class="modal-title"> Gestion Cargos</h4>
                                </div>
                                <form class="form" id="frmCargo">
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">                                               
                                                        ...
                                                        <input name="txtNombre" id="txtNombre" autofocus="" required="" type="text" class="form-control" placeholder="Contador">
                                                    </div>                                                   
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="container-fluid" style="margin-top: 5px">
                            ...
                            <div class="box-body">
                                <div class="table-responsive" >                                 
                                    <table class="table table-bordered table-striped dataTable table-hover" id="TablaCargo" class="display">
                                        <thead>
                                            <tr>
                                                <th>Codigo</th>
                                                <th>Cargo</th>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2019 <a href="#">SISTEMA CONTROL DE PAGOS</a>.</strong> Todos los derechos reservados.
            </footer>
        ...
        <script src="../js/ValidarCargo.js" type="text/javascript"></script>
